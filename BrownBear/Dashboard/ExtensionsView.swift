...
extension ExtensionsView {
    ...
    static let recommended: [RecommendedExtension] = [
        ...
        RecommendedExtension(id: "nngceckbapebfimnlniiiahkandclblb", name: "Bitwarden",
                             ...
                             openSource: true),
        RecommendedExtension(id: "gbefmodhlophhakmoecijeppjblibmie", name: "Linguist",
                             category: "Productivity", iconDomain: "linguister.io",
                             blurb: "Open-source. Translate full pages or selected text, with offline models and a built-in dictionary.",
                             openSource: true),
